...
public class UpcomingTalksActivity extends Activity implements StarCheckListener {
		...
		final ImageView refresh = (ImageView) findViewById(id.refresh);
 		...
 		public void onPostExecute(ArrayList<ScheduleItem> result) {
 			Log.d("bctb","sync done");
 				if(items==null){
 					items = new ScheduleItemAdapter(result, UpcomingTalksActivity.this, getApplicationContext());
 					ListView l = (ListView)findViewById(id.scheduleitems);
 					l.setAdapter(items);
 				}else{
